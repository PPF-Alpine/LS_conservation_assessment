...
mountain_shapes <- sf::st_read(paste(data_storage_path,"Datasets/Mountains/GMBA_Levels/Level_03/GMBA_Inventory_v2.0_Level_03.shp", 
                                     sep = "/"))
# Load both datasets
climate_shifts <- read_csv(file.path(data_storage_path, "Outputs/mountain_climates/all_mountains_climate_shifts_ssp370_2100_20250423.csv")) 
...
plot_path <- paste0(data_storage_path, "Outputs/Figures/mountain_climates/cimatic_shifts_ssp370_", today, ".jpeg")
