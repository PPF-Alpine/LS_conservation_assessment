...
writexl::write_xlsx(assessment_generalists_filter,paste0(data_storage_path,"Datasets/species_assessment/himalaya_mammals.xlsx"))

#----------------------------------------------------------#
# chatgpt cleaning and summarizing test
#----------------------------------------------------------#
# 
generalist_threats<- readxl::read_xlsx(paste0(data_storage_path,"Datasets/species_assessment/himalaya_mammals_processed_new.xlsx"))
...
# Create the bar plot
plot<-ggplot(threat_counts, aes(x = reorder(threats_summary, n), y = n, fill = threats_summary)) +
...
ggsave(paste0(data_storage_path,"Outputs/Figures/species_assessment/threats_himalayan_mammals.png", plot, width = 8, height = 6, dpi = 300))
