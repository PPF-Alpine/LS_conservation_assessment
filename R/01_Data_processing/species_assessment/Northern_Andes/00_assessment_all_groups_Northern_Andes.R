...
# reptiles checklist for Himalaya
...
write.csv(assessment_combined,paste0(data_storage_path,"Outputs/IUCN_assessment_lists/mammals_birds_reptiles_IUCN_Northern_Andes.csv"))
