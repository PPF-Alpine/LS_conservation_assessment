...
luc <- rast(paste0(data_storage_path, "Datasets/human_footprint/LUH_2/multiple-states_input4MIPs_landState_ScenarioMIP_UofMD-MAGPIE-ssp585-2-1-f_gn_2015-2100.nc"))
...
writeRaster(luc_alpine, paste0(data_storage_path, "Datasets/human_footprint/LUH_2/luc_alpine_ssp5_85.tif"), overwrite=TRUE)
